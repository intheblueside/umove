...
DocumentReference? get currentUserReference =>
    loggedIn ? UmoveUsersRecord.collection.doc(currentUser!.uid) : null;

UmoveUsersRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : UmoveUsersRecord.getDocument(UmoveUsersRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
