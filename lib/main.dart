...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    userStream = uMoveFirebaseUserStream()
      ..listen((user) {
...
class _NavBarPageState extends State<NavBarPage> {
  ...
  Widget build(BuildContext context) {
    final tabs = {
      ...
      'RidePage1': const RidePage1Widget(),
      'GameRanking1': const GameRanking1Widget(),
      'BusPage1': const BusPage1Widget(),
    };
    ...
    return Scaffold(
      ...
      bottomNavigationBar: GNav(
        ...
        tabMargin: const EdgeInsets.all(0.0),
